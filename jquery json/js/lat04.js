let tampil = document.querySelector("p");
// let tanggal = document.querySelector("#bulan");
// let bulan = document.querySelector("#tanggal").value;
...
zodiak(bulan.value, tanggal.value);
