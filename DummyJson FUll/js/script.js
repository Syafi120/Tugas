$(document).ready(function () {
    ...
    // ----- ----- Functions to Set Data Pelanggan ----- ----- //

    // ----- Get All Pelanggan ----- //
    function getAllPelanggan() {
        $.ajax({
            type: 'get',
            url: 'http://localhost/axios/select.php',
            dataType: 'json',
            success: function (response) {
                let tbody = ``;
                let no = 1;
    ...
    function addPelanggan(data) {
        $.ajax({
            method: 'POST',
            url: 'http://localhost/axios/insert.php',
    ...
    function updatePelanggan(data) {
        $.ajax({
            method: 'post',
            url: 'http://localhost/axios/update.php',
            data: JSON.stringify(data),
            success: function (response) {
                getAllPelanggan();
    ...
    function deletePelanggan(idpelanggan) {
        $.ajax({
            method: 'post',
            url: 'http://localhost/axios/delete.php',
            data: JSON.stringify(idpelanggan),
            success: function (response) {
                getAllPelanggan();
    ...
    function addPelangganToCart(idpelanggan) {
        $.ajax({
            ...
            success: function (response) {
                let pelanggan = JSON.parse(response);
                $('#tbody-tblPesanan > tr > #pemesan').text(pelanggan.pelanggan);

                dataPesanan.idpelanggan = pelanggan.idpelanggan;
                dataPesanan.pelanggan = pelanggan.pelanggan;
