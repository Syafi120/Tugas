...
function cartData(id){
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            <tr>
                <td>
                    <button class="btn btn-outline-primary" id="btn-order">order</button>
                </td>
            </tr>
            </table>
            `;
...
function getDatapelanggan() {
    $.ajax({
        type: "get",
        url: "http://localhost/Dummyjson/php/get.php",
        cache: false,
        dataType: "json",
        success: function (response) {
            let out = `<thead><tr>
...
function cartPelanggan(id){
    ...
    $.ajax({
        type: "get",
        url: "http://localhost/Dummyjson/php/selectwhere.php?id=" + id,
        data: "contentType",
        dataType: "json",
        success: function (response) {
...
function addDatapelanggan() {
    ...
    $.ajax({
        type: "post",
        url: "http://localhost/Dummyjson/php/add.php",
        cache: false,
...
function selectUpdatepelanggan(id) {
    ...
    $.ajax({
        type: "post",
        url: "http://localhost/Dummyjson/php/selectupdate.php",
        cache: false,
...
function updateDatapelanggan(id) {
    ...
    $.ajax({
        type: "post",
        url: "http://localhost/Dummyjson/php/update.php",
        cache: false,
...
function deleteDatapelanggan(id) {
    ...
    $.ajax({
        type: "post",
        url: "http://localhost/Dummyjson/php/delete.php",
        cache: false,
        data: JSON.stringify(idpelanggan),
        // dataType: "dataType",
        success: function (response) {
